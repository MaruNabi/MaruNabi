...
Shader "Overlay Filters/Overlay G4"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			ASE_DECLARE_SCREENSPACE_TEXTURE( _ScreenGrab4 )
			...
			float FlipY2_g8474( float ScreenOffsetY )
			{
				#if UNITY_UV_STARTS_AT_TOP
				return -ScreenOffsetY * _ProjectionParams.x;
				#else
			...
			float FlipY2_g8452( float ScreenOffsetY )
			{
				#if UNITY_UV_STARTS_AT_TOP
				return -ScreenOffsetY * _ProjectionParams.x;
				#else
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 temp_output_1_0_g8447 = localBranchFading2381;
				float2 temp_output_1_0_g8468 = temp_output_1_0_g8447;
				float4 screenColor21_g8468 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8468);
				float4 appendResult32_g8468 = (float4(max( (screenColor21_g8468).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8469 = temp_output_1_0_g8447;
				float2 break3_g8474 = ( _ZoomBlurPosition - shaderPosition109 );
				float ScreenOffsetY2_g8474 = break3_g8474.y;
				float localFlipY2_g8474 = FlipY2_g8474( ScreenOffsetY2_g8474 );
				float2 appendResult4_g8474 = (float2(break3_g8474.x , localFlipY2_g8474));
				float2 temp_output_66_0_g8469 = appendResult4_g8474;
				float2 normalizeResult16_g8469 = normalize( temp_output_66_0_g8469 );
				float clampResult15_g8469 = clamp( ( length( temp_output_66_0_g8469 ) - _ZoomBlurMinRadius ) , 0.0 , _ZoomBlurMaxRadius );
				float saferPower51_g8469 = max( clampResult15_g8469 , 0.0001 );
				float2 appendResult20_g8469 = (float2(_ScreenParams.y , _ScreenParams.x));
				float temp_output_50_0_g8447 = fullFade153;
				float2 temp_output_17_0_g8469 = ( normalizeResult16_g8469 * pow( saferPower51_g8469 , _ZoomBlurPower ) * _ZoomBlurOffset * ( appendResult20_g8469 / _ScreenParams.y ) * temp_output_50_0_g8447 );
				float2 temp_output_1_0_g8470 = ( temp_output_1_0_g8469 + ( temp_output_17_0_g8469 * float2( 0.0001,0.0001 ) ) );
				float4 screenColor21_g8470 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8470);
				float4 appendResult32_g8470 = (float4(max( (screenColor21_g8470).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8473 = ( temp_output_1_0_g8469 + ( temp_output_17_0_g8469 * float2( 0.0002,0.0002 ) ) );
				float4 screenColor21_g8473 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8473);
				float4 appendResult32_g8473 = (float4(max( (screenColor21_g8473).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8471 = ( temp_output_1_0_g8469 + ( temp_output_17_0_g8469 * float2( 0.0003,0.0003 ) ) );
				float4 screenColor21_g8471 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8471);
				float4 appendResult32_g8471 = (float4(max( (screenColor21_g8471).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8472 = ( temp_output_1_0_g8469 + ( temp_output_17_0_g8469 * float2( 0.0004,0.0004 ) ) );
				float4 screenColor21_g8472 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8472);
				float4 appendResult32_g8472 = (float4(max( (screenColor21_g8472).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_63_0_g8447 = ( ( appendResult32_g8470 + appendResult32_g8473 + appendResult32_g8471 + appendResult32_g8472 ) / 4.0 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch33_g8447 = temp_output_63_0_g8447;
				#else
				float4 staticSwitch33_g8447 = appendResult32_g8468;
				#endif
				float2 appendResult3_g8448 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 appendResult8_g8448 = (float2(_DirectionalBlurOffset , 0.0));
				float3 rotatedValue10_g8448 = RotateAroundAxis( float3( 0,0,0 ), float3( appendResult8_g8448 ,  0.0 ), float3( 0,0,1 ), ( _DirectionalBlurDirection * 0.01745329 ) );
				float2 break3_g8452 = (rotatedValue10_g8448).xy;
				float ScreenOffsetY2_g8452 = break3_g8452.y;
				float localFlipY2_g8452 = FlipY2_g8452( ScreenOffsetY2_g8452 );
				float2 appendResult4_g8452 = (float2(break3_g8452.x , localFlipY2_g8452));
				float2 temp_output_13_0_g8448 = ( ( appendResult3_g8448 / _ScreenParams.y ) * appendResult4_g8452 * temp_output_50_0_g8447 );
				float2 temp_output_1_0_g8448 = temp_output_1_0_g8447;
				float2 temp_output_1_0_g8451 = ( ( temp_output_13_0_g8448 * float2( 0.004,0.004 ) ) + temp_output_1_0_g8448 );
				float4 screenColor21_g8451 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8451);
				float4 appendResult32_g8451 = (float4(max( (screenColor21_g8451).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8449 = ( ( temp_output_13_0_g8448 * float2( 0.002,0.002 ) ) + temp_output_1_0_g8448 );
				float4 screenColor21_g8449 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8449);
				float4 appendResult32_g8449 = (float4(max( (screenColor21_g8449).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8450 = ( ( temp_output_13_0_g8448 * float2( -0.002,-0.002 ) ) + temp_output_1_0_g8448 );
				float4 screenColor21_g8450 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8450);
				float4 appendResult32_g8450 = (float4(max( (screenColor21_g8450).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8453 = ( ( temp_output_13_0_g8448 * float2( -0.004,-0.004 ) ) + temp_output_1_0_g8448 );
				float4 screenColor21_g8453 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8453);
				float4 appendResult32_g8453 = (float4(max( (screenColor21_g8453).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_57_0_g8447 = ( ( appendResult32_g8451 + appendResult32_g8449 + appendResult32_g8450 + appendResult32_g8453 ) * 0.25 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch35_g8447 = ( ( temp_output_63_0_g8447 + temp_output_57_0_g8447 ) * 0.5 );
				#else
				float4 staticSwitch35_g8447 = temp_output_57_0_g8447;
				#endif
				#ifdef _ENABLEDIRECTIONALBLUR_ON
				float4 staticSwitch16_g8447 = staticSwitch35_g8447;
				#else
				float4 staticSwitch16_g8447 = staticSwitch33_g8447;
				#endif
				float2 temp_output_1_0_g8475 = temp_output_1_0_g8447;
				float2 appendResult26_g8475 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 temp_output_27_0_g8475 = ( appendResult26_g8475 / _ScreenParams.y );
				float temp_output_32_0_g8475 = ( _GaussianBlurOffset * 0.001 * temp_output_50_0_g8447 );
				float2 appendResult9_g8475 = (float2(temp_output_32_0_g8475 , temp_output_32_0_g8475));
				float2 temp_output_1_0_g8479 = ( temp_output_1_0_g8475 + ( temp_output_27_0_g8475 * appendResult9_g8475 ) );
				float4 screenColor21_g8479 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8479);
				float4 appendResult32_g8479 = (float4(max( (screenColor21_g8479).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult11_g8475 = (float2(-temp_output_32_0_g8475 , temp_output_32_0_g8475));
				float2 temp_output_1_0_g8478 = ( temp_output_1_0_g8475 + ( temp_output_27_0_g8475 * appendResult11_g8475 ) );
				float4 screenColor21_g8478 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8478);
				float4 appendResult32_g8478 = (float4(max( (screenColor21_g8478).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult15_g8475 = (float2(temp_output_32_0_g8475 , -temp_output_32_0_g8475));
				float2 temp_output_1_0_g8477 = ( temp_output_1_0_g8475 + ( temp_output_27_0_g8475 * appendResult15_g8475 ) );
				float4 screenColor21_g8477 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8477);
				float4 appendResult32_g8477 = (float4(max( (screenColor21_g8477).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult19_g8475 = (float2(-temp_output_32_0_g8475 , -temp_output_32_0_g8475));
				float2 temp_output_1_0_g8476 = ( temp_output_1_0_g8475 + ( temp_output_27_0_g8475 * appendResult19_g8475 ) );
				float4 screenColor21_g8476 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8476);
				float4 appendResult32_g8476 = (float4(max( (screenColor21_g8476).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_58_0_g8447 = ( ( appendResult32_g8479 + appendResult32_g8478 + appendResult32_g8477 + appendResult32_g8476 ) * 0.25 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch39_g8447 = ( ( temp_output_63_0_g8447 + temp_output_58_0_g8447 ) * 0.5 );
				#else
				float4 staticSwitch39_g8447 = temp_output_58_0_g8447;
				#endif
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch46_g8447 = ( ( temp_output_63_0_g8447 + temp_output_57_0_g8447 + temp_output_58_0_g8447 ) * 0.3333333 );
				#else
				float4 staticSwitch46_g8447 = ( ( temp_output_57_0_g8447 + temp_output_58_0_g8447 ) * 0.5 );
				#endif
				#ifdef _ENABLEDIRECTIONALBLUR_ON
				float4 staticSwitch17_g8447 = staticSwitch46_g8447;
				#else
				float4 staticSwitch17_g8447 = staticSwitch39_g8447;
				#endif
				#ifdef _ENABLEGAUSSIANBLUR_ON
				float4 staticSwitch2_g8447 = staticSwitch17_g8447;
				#else
				float4 staticSwitch2_g8447 = staticSwitch16_g8447;
				#endif
				float4 temp_output_44_0_g8454 = staticSwitch2_g8447;
				float2 temp_output_1_0_g8454 = temp_output_1_0_g8447;
				float2 appendResult26_g8454 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 temp_output_27_0_g8454 = ( appendResult26_g8454 / _ScreenParams.y );
				float temp_output_32_0_g8454 = ( _SharpenIntensity * 0.001 * temp_output_50_0_g8447 );
				float2 appendResult9_g8454 = (float2(temp_output_32_0_g8454 , temp_output_32_0_g8454));
				float2 temp_output_1_0_g8456 = ( temp_output_1_0_g8454 + ( temp_output_27_0_g8454 * appendResult9_g8454 ) );
				float4 screenColor21_g8456 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8456);
				float4 appendResult32_g8456 = (float4(max( (screenColor21_g8456).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult11_g8454 = (float2(-temp_output_32_0_g8454 , temp_output_32_0_g8454));
				float2 temp_output_1_0_g8455 = ( temp_output_1_0_g8454 + ( temp_output_27_0_g8454 * appendResult11_g8454 ) );
				float4 screenColor21_g8455 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8455);
				float4 appendResult32_g8455 = (float4(max( (screenColor21_g8455).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult15_g8454 = (float2(temp_output_32_0_g8454 , -temp_output_32_0_g8454));
				float2 temp_output_1_0_g8457 = ( temp_output_1_0_g8454 + ( temp_output_27_0_g8454 * appendResult15_g8454 ) );
				float4 screenColor21_g8457 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8457);
				float4 appendResult32_g8457 = (float4(max( (screenColor21_g8457).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult19_g8454 = (float2(-temp_output_32_0_g8454 , -temp_output_32_0_g8454));
				float2 temp_output_1_0_g8458 = ( temp_output_1_0_g8454 + ( temp_output_27_0_g8454 * appendResult19_g8454 ) );
				float4 screenColor21_g8458 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8458);
				float4 appendResult32_g8458 = (float4(max( (screenColor21_g8458).rgb , float3( 0,0,0 ) ) , 1.0));
				#ifdef _ENABLESHARPEN_ON
				float4 staticSwitch43_g8454 = ( temp_output_44_0_g8454 + ( temp_output_44_0_g8454 - ( ( appendResult32_g8456 + appendResult32_g8455 + appendResult32_g8457 + appendResult32_g8458 ) * 0.25 ) ) );
				#else
				float4 staticSwitch43_g8454 = temp_output_44_0_g8454;
				#endif
				float4 temp_output_2_0_g8459 = staticSwitch43_g8454;
				#ifdef _OUTLINEFILLINSIDE_ON
				float4 staticSwitch73_g8459 = _OutlineFillColor;
				#else
				float4 staticSwitch73_g8459 = temp_output_2_0_g8459;
				#endif
				#ifdef _OUTLINEFILLLINES_ON
				float4 staticSwitch121_g8459 = _OutlineLineColor;
				#else
				float4 staticSwitch121_g8459 = temp_output_2_0_g8459;
				#endif
				float3 hsvTorgb4_g8459 = RGBToHSV( temp_output_2_0_g8459.rgb );
				float3 colorHSV35_g8459 = hsvTorgb4_g8459;
				float3 break10_g8466 = colorHSV35_g8459;
				float2 temp_output_5_0_g8459 = temp_output_1_0_g8447;
				float2 temp_output_1_0_g8467 = ( temp_output_5_0_g8459 + ( float2( 0.01,0 ) * _OutlineWidth ) );
				float4 screenColor21_g8467 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8467);
				float4 appendResult32_g8467 = (float4(max( (screenColor21_g8467).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8466 = RGBToHSV( appendResult32_g8467.xyz );
				float saferPower41_g8466 = max( distance( break10_g8466.x , hsvTorgb6_g8466.x ) , 0.0001 );
				float hueT38_g8459 = _OutlineHueTolerance;
				float saferPower42_g8466 = max( distance( break10_g8466.y , hsvTorgb6_g8466.y ) , 0.0001 );
				float saturationT40_g8459 = _OutlineSaturationTolerance;
				float saferPower43_g8466 = max( distance( break10_g8466.z , hsvTorgb6_g8466.z ) , 0.0001 );
				float brightnessT42_g8459 = _OutlineBrightnessTolerance;
				float3 break10_g8460 = colorHSV35_g8459;
				float2 temp_output_1_0_g8461 = ( temp_output_5_0_g8459 + ( float2( -0.01,0 ) * _OutlineWidth ) );
				float4 screenColor21_g8461 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8461);
				float4 appendResult32_g8461 = (float4(max( (screenColor21_g8461).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8460 = RGBToHSV( appendResult32_g8461.xyz );
				float saferPower41_g8460 = max( distance( break10_g8460.x , hsvTorgb6_g8460.x ) , 0.0001 );
				float saferPower42_g8460 = max( distance( break10_g8460.y , hsvTorgb6_g8460.y ) , 0.0001 );
				float saferPower43_g8460 = max( distance( break10_g8460.z , hsvTorgb6_g8460.z ) , 0.0001 );
				float3 break10_g8464 = colorHSV35_g8459;
				float2 temp_output_1_0_g8465 = ( temp_output_5_0_g8459 + ( _OutlineWidth * float2( 0,-0.01 ) ) );
				float4 screenColor21_g8465 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8465);
				float4 appendResult32_g8465 = (float4(max( (screenColor21_g8465).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8464 = RGBToHSV( appendResult32_g8465.xyz );
				float saferPower41_g8464 = max( distance( break10_g8464.x , hsvTorgb6_g8464.x ) , 0.0001 );
				float saferPower42_g8464 = max( distance( break10_g8464.y , hsvTorgb6_g8464.y ) , 0.0001 );
				float saferPower43_g8464 = max( distance( break10_g8464.z , hsvTorgb6_g8464.z ) , 0.0001 );
				float3 break10_g8462 = colorHSV35_g8459;
				float2 temp_output_1_0_g8463 = ( temp_output_5_0_g8459 + ( _OutlineWidth * float2( 0,0.01 ) ) );
				float4 screenColor21_g8463 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab4,temp_output_1_0_g8463);
				float4 appendResult32_g8463 = (float4(max( (screenColor21_g8463).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8462 = RGBToHSV( appendResult32_g8463.xyz );
				float saferPower41_g8462 = max( distance( break10_g8462.x , hsvTorgb6_g8462.x ) , 0.0001 );
				float saferPower42_g8462 = max( distance( break10_g8462.y , hsvTorgb6_g8462.y ) , 0.0001 );
				float saferPower43_g8462 = max( distance( break10_g8462.z , hsvTorgb6_g8462.z ) , 0.0001 );
				float4 lerpResult67_g8459 = lerp( staticSwitch73_g8459 , staticSwitch121_g8459 , step( min( min( max( ( 1.0 - ( pow( saferPower41_g8466 , hueT38_g8459 ) * pow( saferPower42_g8466 , saturationT40_g8459 ) * pow( saferPower43_g8466 , brightnessT42_g8459 ) ) ) , 0.0 ) , max( ( 1.0 - ( pow( saferPower41_g8460 , hueT38_g8459 ) * pow( saferPower42_g8460 , saturationT40_g8459 ) * pow( saferPower43_g8460 , brightnessT42_g8459 ) ) ) , 0.0 ) ) , min( max( ( 1.0 - ( pow( saferPower41_g8464 , hueT38_g8459 ) * pow( saferPower42_g8464 , saturationT40_g8459 ) * pow( saferPower43_g8464 , brightnessT42_g8459 ) ) ) , 0.0 ) , max( ( 1.0 - ( pow( saferPower41_g8462 , hueT38_g8459 ) * pow( saferPower42_g8462 , saturationT40_g8459 ) * pow( saferPower43_g8462 , brightnessT42_g8459 ) ) ) , 0.0 ) ) ) , _OutlineBias ));
				float InputA128_g8459 = ( _OutlineFade * temp_output_50_0_g8447 );
				float InputB128_g8459 = _OutlineFade;
				float localBranchFading1128_g8459 = BranchFading1( InputA128_g8459 , InputB128_g8459 );
				float4 lerpResult77_g8459 = lerp( temp_output_2_0_g8459 , lerpResult67_g8459 , localBranchFading1128_g8459);
				#ifdef _ENABLEOUTLINE_ON
				float4 staticSwitch74_g8459 = lerpResult77_g8459;
				#else
				float4 staticSwitch74_g8459 = temp_output_2_0_g8459;
				#endif
				float4 temp_output_410_0 = staticSwitch74_g8459;
				float4 temp_output_1_0_g8421 = temp_output_410_0;
				float4 break2_g8423 = temp_output_1_0_g8421;
				float temp_output_34_0_g8421 = shaderTime129;
				float3 hsvTorgb3_g8422 = HSVToRGB( float3(( tex2D( _NoiseTexture, ( ( glitchPosition117 + ( _GlitchNoiseSpeed * temp_output_34_0_g8421 ) ) * _GlitchNoiseScale ) ).r + ( temp_output_34_0_g8421 * _GlitchHueSpeed ) ),1.0,1.0) );
				float3 lerpResult23_g8421 = lerp( (temp_output_1_0_g8421).rgb , ( ( ( break2_g8423.x + break2_g8423.y + break2_g8423.z ) / 3.0 ) * _GlitchBrightness * hsvTorgb3_g8422 ) , glitchFade116);
				float4 appendResult27_g8421 = (float4(lerpResult23_g8421 , temp_output_1_0_g8421.a));
				#ifdef _ENABLEGLITCH_ON
				float4 staticSwitch123 = appendResult27_g8421;
				#else
				float4 staticSwitch123 = temp_output_410_0;
				#endif
				float4 temp_output_1_0_g8430 = staticSwitch123;
				float3 temp_output_4_0_g8430 = (temp_output_1_0_g8430).rgb;
				float4 break2_g8431 = float4( temp_output_4_0_g8430 , 0.0 );
				float3 temp_cast_11 = (max( ( ( break2_g8431.x + break2_g8431.y + break2_g8431.z ) / 3.0 ) , 0.1 )).xxx;
				float3 lerpResult8_g8430 = lerp( temp_cast_11 , temp_output_4_0_g8430 , _LightSaturation);
				float3 saferPower9_g8430 = max( lerpResult8_g8430 , 0.0001 );
				float3 temp_cast_12 = (_LightContrast).xxx;
				float4 appendResult14_g8430 = (float4(( ( _LightIntensity * pow( saferPower9_g8430 , temp_cast_12 ) ) + temp_output_4_0_g8430 ) , temp_output_1_0_g8430.a));
				#ifdef _ENABLELIGHT_ON
				float4 staticSwitch12_g8430 = appendResult14_g8430;
				#else
				float4 staticSwitch12_g8430 = temp_output_1_0_g8430;
				#endif
				float4 temp_output_1_0_g8428 = staticSwitch12_g8430;
				float temp_output_37_0_g8425 = shaderTime129;
				float2 temp_output_35_0_g8425 = shaderPosition109;
				float3 rotatedValue6_g8428 = RotateAroundAxis( float3( 1000,1000,0 ), float3( temp_output_35_0_g8425 ,  0.0 ), float3( 0,0,1 ), ( _StaticNoiseSpeed * temp_output_37_0_g8425 ) );
				float temp_output_7_0_g8428 = tex2D( _NoiseTexture, ( rotatedValue6_g8428.xy * _StaticNoiseScale ) ).r;
				float4 appendResult14_g8428 = (float4(temp_output_7_0_g8428 , temp_output_7_0_g8428 , temp_output_7_0_g8428 , temp_output_1_0_g8428.a));
				float4 lerpResult10_g8428 = lerp( temp_output_1_0_g8428 , appendResult14_g8428 , _StaticNoiseFade);
				#ifdef _ENABLESTATICNOISE_ON
				float4 staticSwitch15_g8428 = lerpResult10_g8428;
				#else
				float4 staticSwitch15_g8428 = temp_output_1_0_g8428;
				#endif
				float4 temp_output_1_0_g8443 = staticSwitch15_g8428;
				float2 temp_output_42_0_g8443 = temp_output_35_0_g8425;
				float3 hsvTorgb3_g8446 = HSVToRGB( float3(( ( ( _RainbowZoomDensity * distance( temp_output_42_0_g8443 , _RainbowCenter ) ) + ( tex2D( _NoiseTexture, ( temp_output_42_0_g8443 * _RainbowNoiseScale ) ).r * _RainbowNoiseFactor ) ) + ( _RainbowSpeed * temp_output_37_0_g8425 ) ),1.0,1.0) );
				float3 hsvTorgb36_g8443 = RGBToHSV( hsvTorgb3_g8446 );
				float3 hsvTorgb37_g8443 = HSVToRGB( float3(hsvTorgb36_g8443.x,_RainbowSaturation,( hsvTorgb36_g8443.z * _RainbowBrightness )) );
				float4 break2_g8445 = temp_output_1_0_g8443;
				float saferPower24_g8443 = max( ( ( break2_g8445.x + break2_g8445.y + break2_g8445.z ) / 3.0 ) , 0.0001 );
				float3 lerpResult46_g8443 = lerp( (temp_output_1_0_g8443).rgb , ( hsvTorgb37_g8443 * pow( saferPower24_g8443 , max( _RainbowContrast , 0.01 ) ) ) , _RainbowFade);
				float4 appendResult29_g8443 = (float4(lerpResult46_g8443 , temp_output_1_0_g8443.a));
				#ifdef _ENABLERAINBOW_ON
				float4 staticSwitch45_g8443 = appendResult29_g8443;
				#else
				float4 staticSwitch45_g8443 = temp_output_1_0_g8443;
				#endif
				float4 temp_output_1_0_g8427 = staticSwitch45_g8443;
				float3 hsvTorgb2_g8427 = RGBToHSV( temp_output_1_0_g8427.rgb );
				float3 hsvTorgb5_g8427 = HSVToRGB( float3(( floor( ( hsvTorgb2_g8427.x * _LimitColorsHueSteps ) ) / _LimitColorsHueSteps ),( floor( ( hsvTorgb2_g8427.y * _LimitColorsSaturationSteps ) ) / _LimitColorsSaturationSteps ),( floor( ( hsvTorgb2_g8427.z * _LimitColorsBrightnessSteps ) ) / _LimitColorsBrightnessSteps )) );
				float3 lerpResult8_g8427 = lerp( (temp_output_1_0_g8427).rgb , hsvTorgb5_g8427 , _LimitColorsFade);
				float4 appendResult4_g8427 = (float4(lerpResult8_g8427 , temp_output_1_0_g8427.a));
				#ifdef _ENABLELIMITCOLORS_ON
				float4 staticSwitch6_g8427 = appendResult4_g8427;
				#else
				float4 staticSwitch6_g8427 = temp_output_1_0_g8427;
				#endif
				float4 temp_output_1_0_g8438 = staticSwitch6_g8427;
				float4 break2_g8439 = temp_output_1_0_g8438;
				float temp_output_2_0_g8438 = ( ( break2_g8439.x + break2_g8439.y + break2_g8439.z ) / 3.0 );
				float temp_output_4_0_g8438 = step( _ColorStepsStep1 , temp_output_2_0_g8438 );
				float temp_output_10_0_g8438 = step( _ColorStepsStep3 , temp_output_2_0_g8438 );
				float temp_output_14_0_g8438 = max( ( step( _ColorStepsStep2 , temp_output_2_0_g8438 ) - temp_output_10_0_g8438 ) , 0.0 );
				float3 lerpResult31_g8438 = lerp( (temp_output_1_0_g8438).rgb , ( ( (_ColorStepsColor0).rgb * ( 1.0 - temp_output_4_0_g8438 ) ) + ( (_ColorStepsColor1).rgb * max( ( temp_output_4_0_g8438 - temp_output_14_0_g8438 ) , 0.0 ) ) + ( temp_output_14_0_g8438 * (_ColorStepsColor2).rgb ) + ( temp_output_10_0_g8438 * (_ColorStepsColor3).rgb ) ) , _ColorStepsFade);
				float4 appendResult34_g8438 = (float4(lerpResult31_g8438 , temp_output_1_0_g8438.a));
				#ifdef _ENABLECOLORSTEPS_ON
				float4 staticSwitch36_g8438 = appendResult34_g8438;
				#else
				float4 staticSwitch36_g8438 = temp_output_1_0_g8438;
				#endif
				float4 temp_output_1_0_g8440 = staticSwitch36_g8438;
				float3 temp_output_6_0_g8440 = (temp_output_1_0_g8440).rgb;
				float3 lerpResult3_g8440 = lerp( temp_output_6_0_g8440 , ( 1.0 - temp_output_6_0_g8440 ) , _NegativeFade);
				float4 appendResult7_g8440 = (float4(lerpResult3_g8440 , temp_output_1_0_g8440.a));
				#ifdef _ENABLENEGATIVE_ON
				float4 staticSwitch5_g8440 = appendResult7_g8440;
				#else
				float4 staticSwitch5_g8440 = temp_output_1_0_g8440;
				#endif
				float4 temp_output_1_0_g8441 = staticSwitch5_g8440;
				float4 break2_g8442 = temp_output_1_0_g8441;
				float3 lerpResult15_g8441 = lerp( (temp_output_1_0_g8441).rgb , ( pow( max( ( ( break2_g8442.x + break2_g8442.y + break2_g8442.z ) / 3.0 ) , 0.0001 ) , _SingleToneContrast ) * (_SingleToneColor).rgb ) , _SingleToneFade);
				float4 appendResult10_g8441 = (float4(lerpResult15_g8441 , temp_output_1_0_g8441.a));
				#ifdef _ENABLESINGLETONE_ON
				float4 staticSwitch2_g8441 = appendResult10_g8441;
				#else
				float4 staticSwitch2_g8441 = temp_output_1_0_g8441;
				#endif
				float4 temp_output_1_0_g8432 = staticSwitch2_g8441;
				float4 break2_g8433 = temp_output_1_0_g8432;
				float temp_output_3_0_g8432 = ( ( break2_g8433.x + break2_g8433.y + break2_g8433.z ) / 3.0 );
				float clampResult25_g8432 = clamp( ( ( ( ( temp_output_3_0_g8432 + _SplitToneShift ) - 0.5 ) * _SplitTonePolarize ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g8432 = lerp( (_SplitToneShadowsColor).rgb , (_SplitToneHighlightsColor).rgb , clampResult25_g8432);
				float saferPower26_g8432 = max( max( temp_output_3_0_g8432 , 0.0001 ) , 0.0001 );
				float3 lerpResult11_g8432 = lerp( (temp_output_1_0_g8432).rgb , ( lerpResult6_g8432 * pow( saferPower26_g8432 , _SplitToneContrast ) ) , _SplitToneFade);
				float4 appendResult18_g8432 = (float4(lerpResult11_g8432 , temp_output_1_0_g8432.a));
				#ifdef _ENABLESPLITTONE_ON
				float4 staticSwitch27_g8432 = appendResult18_g8432;
				#else
				float4 staticSwitch27_g8432 = temp_output_1_0_g8432;
				#endif
				float4 temp_output_1_0_g8434 = staticSwitch27_g8432;
				float3 hsvTorgb8_g8434 = RGBToHSV( temp_output_1_0_g8434.rgb );
				float saferPower5_g8434 = max( hsvTorgb8_g8434.z , 0.0001 );
				float3 hsvTorgb9_g8434 = HSVToRGB( float3(hsvTorgb8_g8434.x,hsvTorgb8_g8434.y,pow( saferPower5_g8434 , _Contrast )) );
				float4 appendResult4_g8434 = (float4(hsvTorgb9_g8434 , temp_output_1_0_g8434.a));
				#ifdef _ENABLECONTRAST_ON
				float4 staticSwitch7_g8434 = appendResult4_g8434;
				#else
				float4 staticSwitch7_g8434 = temp_output_1_0_g8434;
				#endif
				float4 temp_output_2_0_g8435 = staticSwitch7_g8434;
				float3 hsvTorgb1_g8435 = RGBToHSV( temp_output_2_0_g8435.rgb );
				float3 hsvTorgb3_g8435 = HSVToRGB( float3(_Hue,hsvTorgb1_g8435.y,hsvTorgb1_g8435.z) );
				float4 appendResult8_g8435 = (float4(hsvTorgb3_g8435 , temp_output_2_0_g8435.a));
				#ifdef _ENABLEHUE_ON
				float4 staticSwitch9_g8435 = appendResult8_g8435;
				#else
				float4 staticSwitch9_g8435 = temp_output_2_0_g8435;
				#endif
				float4 temp_output_6_0_g8436 = staticSwitch9_g8435;
				float4 break2_g8437 = temp_output_6_0_g8436;
				float3 temp_cast_34 = (( ( break2_g8437.x + break2_g8437.y + break2_g8437.z ) / 3.0 )).xxx;
				float3 lerpResult7_g8436 = lerp( temp_cast_34 , (temp_output_6_0_g8436).rgb , _Saturation);
				float4 appendResult3_g8436 = (float4(lerpResult7_g8436 , temp_output_6_0_g8436.a));
				#ifdef _ENABLESATURATION_ON
				float4 staticSwitch10_g8436 = appendResult3_g8436;
				#else
				float4 staticSwitch10_g8436 = temp_output_6_0_g8436;
				#endif
				float4 temp_output_2_0_g8426 = staticSwitch10_g8436;
				float4 appendResult6_g8426 = (float4(( (temp_output_2_0_g8426).rgb * _Brightness ) , temp_output_2_0_g8426.a));
				#ifdef _ENABLEBRIGHTNESS_ON
				float4 staticSwitch8_g8426 = appendResult6_g8426;
				#else
				float4 staticSwitch8_g8426 = temp_output_2_0_g8426;
				#endif
				float4 temp_output_280_0 = staticSwitch8_g8426;
				float4 lerpResult170 = lerp( temp_output_410_0 , temp_output_280_0 , fullFade153);
...
Node;AmplifyShaderEditor.FunctionNode;410;-111.3018,15.60661;Inherit;False;_Sample;109;;8447;9b7fc20dc45a5454c991b15678891b18;0;3;31;FLOAT2;0,0;False;1;FLOAT2;0,0;False;50;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;282;258.6629,284.8721;Inherit;False;OverlayGlitch;173;;8421;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;0;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;280;1011.876,95.09289;Inherit;False;_Color;43;;8425;87857c725b66a6f4a93d0f2a3f185435;0;4;1;COLOR;0,0,0,0;False;35;FLOAT2;0,0;False;36;SAMPLER2D;0;False;37;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;1994.455,296.1124;Float;False;True;-1;2;OverlayFilters.OverlayShaderGUI;0;6;Overlay Filters/Overlay G4;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;False;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;True;True;True;True;True;0;True;-9;False;False;False;False;False;False;False;True;True;0;True;-5;255;True;-8;255;True;-7;0;True;-4;0;True;-6;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;0;True;-11;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
WireConnection;410;31;110;0
WireConnection;410;1;381;0
WireConnection;410;50;190;0
WireConnection;282;34;131;0
WireConnection;282;31;121;0
WireConnection;282;33;122;0
WireConnection;282;29;120;0
WireConnection;282;1;410;0
WireConnection;123;1;410;0
...
ASEEND*/
//CHKSM=C5973D2EE6CEF87EFD12A010CC25468A4BB97EE2