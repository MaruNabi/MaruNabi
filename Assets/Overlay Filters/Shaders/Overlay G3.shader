...
Shader "Overlay Filters/Overlay G3"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			ASE_DECLARE_SCREENSPACE_TEXTURE( _ScreenGrab3 )
			...
			float FlipY2_g8514( float ScreenOffsetY )
			{
				#if UNITY_UV_STARTS_AT_TOP
				return -ScreenOffsetY * _ProjectionParams.x;
				#else
			...
			float FlipY2_g8492( float ScreenOffsetY )
			{
				#if UNITY_UV_STARTS_AT_TOP
				return -ScreenOffsetY * _ProjectionParams.x;
				#else
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 temp_output_1_0_g8487 = localBranchFading2381;
				float2 temp_output_1_0_g8508 = temp_output_1_0_g8487;
				float4 screenColor20_g8508 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8508);
				float4 appendResult32_g8508 = (float4(max( (screenColor20_g8508).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8509 = temp_output_1_0_g8487;
				float2 break3_g8514 = ( _ZoomBlurPosition - shaderPosition109 );
				float ScreenOffsetY2_g8514 = break3_g8514.y;
				float localFlipY2_g8514 = FlipY2_g8514( ScreenOffsetY2_g8514 );
				float2 appendResult4_g8514 = (float2(break3_g8514.x , localFlipY2_g8514));
				float2 temp_output_66_0_g8509 = appendResult4_g8514;
				float2 normalizeResult16_g8509 = normalize( temp_output_66_0_g8509 );
				float clampResult15_g8509 = clamp( ( length( temp_output_66_0_g8509 ) - _ZoomBlurMinRadius ) , 0.0 , _ZoomBlurMaxRadius );
				float saferPower51_g8509 = max( clampResult15_g8509 , 0.0001 );
				float2 appendResult20_g8509 = (float2(_ScreenParams.y , _ScreenParams.x));
				float temp_output_50_0_g8487 = fullFade153;
				float2 temp_output_17_0_g8509 = ( normalizeResult16_g8509 * pow( saferPower51_g8509 , _ZoomBlurPower ) * _ZoomBlurOffset * ( appendResult20_g8509 / _ScreenParams.y ) * temp_output_50_0_g8487 );
				float2 temp_output_1_0_g8510 = ( temp_output_1_0_g8509 + ( temp_output_17_0_g8509 * float2( 0.0001,0.0001 ) ) );
				float4 screenColor20_g8510 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8510);
				float4 appendResult32_g8510 = (float4(max( (screenColor20_g8510).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8513 = ( temp_output_1_0_g8509 + ( temp_output_17_0_g8509 * float2( 0.0002,0.0002 ) ) );
				float4 screenColor20_g8513 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8513);
				float4 appendResult32_g8513 = (float4(max( (screenColor20_g8513).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8511 = ( temp_output_1_0_g8509 + ( temp_output_17_0_g8509 * float2( 0.0003,0.0003 ) ) );
				float4 screenColor20_g8511 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8511);
				float4 appendResult32_g8511 = (float4(max( (screenColor20_g8511).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8512 = ( temp_output_1_0_g8509 + ( temp_output_17_0_g8509 * float2( 0.0004,0.0004 ) ) );
				float4 screenColor20_g8512 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8512);
				float4 appendResult32_g8512 = (float4(max( (screenColor20_g8512).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_63_0_g8487 = ( ( appendResult32_g8510 + appendResult32_g8513 + appendResult32_g8511 + appendResult32_g8512 ) / 4.0 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch33_g8487 = temp_output_63_0_g8487;
				#else
				float4 staticSwitch33_g8487 = appendResult32_g8508;
				#endif
				float2 appendResult3_g8488 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 appendResult8_g8488 = (float2(_DirectionalBlurOffset , 0.0));
				float3 rotatedValue10_g8488 = RotateAroundAxis( float3( 0,0,0 ), float3( appendResult8_g8488 ,  0.0 ), float3( 0,0,1 ), ( _DirectionalBlurDirection * 0.01745329 ) );
				float2 break3_g8492 = (rotatedValue10_g8488).xy;
				float ScreenOffsetY2_g8492 = break3_g8492.y;
				float localFlipY2_g8492 = FlipY2_g8492( ScreenOffsetY2_g8492 );
				float2 appendResult4_g8492 = (float2(break3_g8492.x , localFlipY2_g8492));
				float2 temp_output_13_0_g8488 = ( ( appendResult3_g8488 / _ScreenParams.y ) * appendResult4_g8492 * temp_output_50_0_g8487 );
				float2 temp_output_1_0_g8488 = temp_output_1_0_g8487;
				float2 temp_output_1_0_g8491 = ( ( temp_output_13_0_g8488 * float2( 0.004,0.004 ) ) + temp_output_1_0_g8488 );
				float4 screenColor20_g8491 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8491);
				float4 appendResult32_g8491 = (float4(max( (screenColor20_g8491).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8489 = ( ( temp_output_13_0_g8488 * float2( 0.002,0.002 ) ) + temp_output_1_0_g8488 );
				float4 screenColor20_g8489 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8489);
				float4 appendResult32_g8489 = (float4(max( (screenColor20_g8489).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8490 = ( ( temp_output_13_0_g8488 * float2( -0.002,-0.002 ) ) + temp_output_1_0_g8488 );
				float4 screenColor20_g8490 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8490);
				float4 appendResult32_g8490 = (float4(max( (screenColor20_g8490).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8493 = ( ( temp_output_13_0_g8488 * float2( -0.004,-0.004 ) ) + temp_output_1_0_g8488 );
				float4 screenColor20_g8493 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8493);
				float4 appendResult32_g8493 = (float4(max( (screenColor20_g8493).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_57_0_g8487 = ( ( appendResult32_g8491 + appendResult32_g8489 + appendResult32_g8490 + appendResult32_g8493 ) * 0.25 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch35_g8487 = ( ( temp_output_63_0_g8487 + temp_output_57_0_g8487 ) * 0.5 );
				#else
				float4 staticSwitch35_g8487 = temp_output_57_0_g8487;
				#endif
				#ifdef _ENABLEDIRECTIONALBLUR_ON
				float4 staticSwitch16_g8487 = staticSwitch35_g8487;
				#else
				float4 staticSwitch16_g8487 = staticSwitch33_g8487;
				#endif
				float2 temp_output_1_0_g8515 = temp_output_1_0_g8487;
				float2 appendResult26_g8515 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 temp_output_27_0_g8515 = ( appendResult26_g8515 / _ScreenParams.y );
				float temp_output_32_0_g8515 = ( _GaussianBlurOffset * 0.001 * temp_output_50_0_g8487 );
				float2 appendResult9_g8515 = (float2(temp_output_32_0_g8515 , temp_output_32_0_g8515));
				float2 temp_output_1_0_g8519 = ( temp_output_1_0_g8515 + ( temp_output_27_0_g8515 * appendResult9_g8515 ) );
				float4 screenColor20_g8519 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8519);
				float4 appendResult32_g8519 = (float4(max( (screenColor20_g8519).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult11_g8515 = (float2(-temp_output_32_0_g8515 , temp_output_32_0_g8515));
				float2 temp_output_1_0_g8518 = ( temp_output_1_0_g8515 + ( temp_output_27_0_g8515 * appendResult11_g8515 ) );
				float4 screenColor20_g8518 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8518);
				float4 appendResult32_g8518 = (float4(max( (screenColor20_g8518).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult15_g8515 = (float2(temp_output_32_0_g8515 , -temp_output_32_0_g8515));
				float2 temp_output_1_0_g8517 = ( temp_output_1_0_g8515 + ( temp_output_27_0_g8515 * appendResult15_g8515 ) );
				float4 screenColor20_g8517 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8517);
				float4 appendResult32_g8517 = (float4(max( (screenColor20_g8517).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult19_g8515 = (float2(-temp_output_32_0_g8515 , -temp_output_32_0_g8515));
				float2 temp_output_1_0_g8516 = ( temp_output_1_0_g8515 + ( temp_output_27_0_g8515 * appendResult19_g8515 ) );
				float4 screenColor20_g8516 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8516);
				float4 appendResult32_g8516 = (float4(max( (screenColor20_g8516).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_58_0_g8487 = ( ( appendResult32_g8519 + appendResult32_g8518 + appendResult32_g8517 + appendResult32_g8516 ) * 0.25 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch39_g8487 = ( ( temp_output_63_0_g8487 + temp_output_58_0_g8487 ) * 0.5 );
				#else
				float4 staticSwitch39_g8487 = temp_output_58_0_g8487;
				#endif
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch46_g8487 = ( ( temp_output_63_0_g8487 + temp_output_57_0_g8487 + temp_output_58_0_g8487 ) * 0.3333333 );
				#else
				float4 staticSwitch46_g8487 = ( ( temp_output_57_0_g8487 + temp_output_58_0_g8487 ) * 0.5 );
				#endif
				#ifdef _ENABLEDIRECTIONALBLUR_ON
				float4 staticSwitch17_g8487 = staticSwitch46_g8487;
				#else
				float4 staticSwitch17_g8487 = staticSwitch39_g8487;
				#endif
				#ifdef _ENABLEGAUSSIANBLUR_ON
				float4 staticSwitch2_g8487 = staticSwitch17_g8487;
				#else
				float4 staticSwitch2_g8487 = staticSwitch16_g8487;
				#endif
				float4 temp_output_44_0_g8494 = staticSwitch2_g8487;
				float2 temp_output_1_0_g8494 = temp_output_1_0_g8487;
				float2 appendResult26_g8494 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 temp_output_27_0_g8494 = ( appendResult26_g8494 / _ScreenParams.y );
				float temp_output_32_0_g8494 = ( _SharpenIntensity * 0.001 * temp_output_50_0_g8487 );
				float2 appendResult9_g8494 = (float2(temp_output_32_0_g8494 , temp_output_32_0_g8494));
				float2 temp_output_1_0_g8496 = ( temp_output_1_0_g8494 + ( temp_output_27_0_g8494 * appendResult9_g8494 ) );
				float4 screenColor20_g8496 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8496);
				float4 appendResult32_g8496 = (float4(max( (screenColor20_g8496).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult11_g8494 = (float2(-temp_output_32_0_g8494 , temp_output_32_0_g8494));
				float2 temp_output_1_0_g8495 = ( temp_output_1_0_g8494 + ( temp_output_27_0_g8494 * appendResult11_g8494 ) );
				float4 screenColor20_g8495 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8495);
				float4 appendResult32_g8495 = (float4(max( (screenColor20_g8495).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult15_g8494 = (float2(temp_output_32_0_g8494 , -temp_output_32_0_g8494));
				float2 temp_output_1_0_g8497 = ( temp_output_1_0_g8494 + ( temp_output_27_0_g8494 * appendResult15_g8494 ) );
				float4 screenColor20_g8497 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8497);
				float4 appendResult32_g8497 = (float4(max( (screenColor20_g8497).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult19_g8494 = (float2(-temp_output_32_0_g8494 , -temp_output_32_0_g8494));
				float2 temp_output_1_0_g8498 = ( temp_output_1_0_g8494 + ( temp_output_27_0_g8494 * appendResult19_g8494 ) );
				float4 screenColor20_g8498 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8498);
				float4 appendResult32_g8498 = (float4(max( (screenColor20_g8498).rgb , float3( 0,0,0 ) ) , 1.0));
				#ifdef _ENABLESHARPEN_ON
				float4 staticSwitch43_g8494 = ( temp_output_44_0_g8494 + ( temp_output_44_0_g8494 - ( ( appendResult32_g8496 + appendResult32_g8495 + appendResult32_g8497 + appendResult32_g8498 ) * 0.25 ) ) );
				#else
				float4 staticSwitch43_g8494 = temp_output_44_0_g8494;
				#endif
				float4 temp_output_2_0_g8499 = staticSwitch43_g8494;
				#ifdef _OUTLINEFILLINSIDE_ON
				float4 staticSwitch73_g8499 = _OutlineFillColor;
				#else
				float4 staticSwitch73_g8499 = temp_output_2_0_g8499;
				#endif
				#ifdef _OUTLINEFILLLINES_ON
				float4 staticSwitch121_g8499 = _OutlineLineColor;
				#else
				float4 staticSwitch121_g8499 = temp_output_2_0_g8499;
				#endif
				float3 hsvTorgb4_g8499 = RGBToHSV( temp_output_2_0_g8499.rgb );
				float3 colorHSV35_g8499 = hsvTorgb4_g8499;
				float3 break10_g8506 = colorHSV35_g8499;
				float2 temp_output_5_0_g8499 = temp_output_1_0_g8487;
				float2 temp_output_1_0_g8507 = ( temp_output_5_0_g8499 + ( float2( 0.01,0 ) * _OutlineWidth ) );
				float4 screenColor20_g8507 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8507);
				float4 appendResult32_g8507 = (float4(max( (screenColor20_g8507).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8506 = RGBToHSV( appendResult32_g8507.xyz );
				float saferPower41_g8506 = max( distance( break10_g8506.x , hsvTorgb6_g8506.x ) , 0.0001 );
				float hueT38_g8499 = _OutlineHueTolerance;
				float saferPower42_g8506 = max( distance( break10_g8506.y , hsvTorgb6_g8506.y ) , 0.0001 );
				float saturationT40_g8499 = _OutlineSaturationTolerance;
				float saferPower43_g8506 = max( distance( break10_g8506.z , hsvTorgb6_g8506.z ) , 0.0001 );
				float brightnessT42_g8499 = _OutlineBrightnessTolerance;
				float3 break10_g8500 = colorHSV35_g8499;
				float2 temp_output_1_0_g8501 = ( temp_output_5_0_g8499 + ( float2( -0.01,0 ) * _OutlineWidth ) );
				float4 screenColor20_g8501 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8501);
				float4 appendResult32_g8501 = (float4(max( (screenColor20_g8501).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8500 = RGBToHSV( appendResult32_g8501.xyz );
				float saferPower41_g8500 = max( distance( break10_g8500.x , hsvTorgb6_g8500.x ) , 0.0001 );
				float saferPower42_g8500 = max( distance( break10_g8500.y , hsvTorgb6_g8500.y ) , 0.0001 );
				float saferPower43_g8500 = max( distance( break10_g8500.z , hsvTorgb6_g8500.z ) , 0.0001 );
				float3 break10_g8504 = colorHSV35_g8499;
				float2 temp_output_1_0_g8505 = ( temp_output_5_0_g8499 + ( _OutlineWidth * float2( 0,-0.01 ) ) );
				float4 screenColor20_g8505 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8505);
				float4 appendResult32_g8505 = (float4(max( (screenColor20_g8505).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8504 = RGBToHSV( appendResult32_g8505.xyz );
				float saferPower41_g8504 = max( distance( break10_g8504.x , hsvTorgb6_g8504.x ) , 0.0001 );
				float saferPower42_g8504 = max( distance( break10_g8504.y , hsvTorgb6_g8504.y ) , 0.0001 );
				float saferPower43_g8504 = max( distance( break10_g8504.z , hsvTorgb6_g8504.z ) , 0.0001 );
				float3 break10_g8502 = colorHSV35_g8499;
				float2 temp_output_1_0_g8503 = ( temp_output_5_0_g8499 + ( _OutlineWidth * float2( 0,0.01 ) ) );
				float4 screenColor20_g8503 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab3,temp_output_1_0_g8503);
				float4 appendResult32_g8503 = (float4(max( (screenColor20_g8503).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8502 = RGBToHSV( appendResult32_g8503.xyz );
				float saferPower41_g8502 = max( distance( break10_g8502.x , hsvTorgb6_g8502.x ) , 0.0001 );
				float saferPower42_g8502 = max( distance( break10_g8502.y , hsvTorgb6_g8502.y ) , 0.0001 );
				float saferPower43_g8502 = max( distance( break10_g8502.z , hsvTorgb6_g8502.z ) , 0.0001 );
				float4 lerpResult67_g8499 = lerp( staticSwitch73_g8499 , staticSwitch121_g8499 , step( min( min( max( ( 1.0 - ( pow( saferPower41_g8506 , hueT38_g8499 ) * pow( saferPower42_g8506 , saturationT40_g8499 ) * pow( saferPower43_g8506 , brightnessT42_g8499 ) ) ) , 0.0 ) , max( ( 1.0 - ( pow( saferPower41_g8500 , hueT38_g8499 ) * pow( saferPower42_g8500 , saturationT40_g8499 ) * pow( saferPower43_g8500 , brightnessT42_g8499 ) ) ) , 0.0 ) ) , min( max( ( 1.0 - ( pow( saferPower41_g8504 , hueT38_g8499 ) * pow( saferPower42_g8504 , saturationT40_g8499 ) * pow( saferPower43_g8504 , brightnessT42_g8499 ) ) ) , 0.0 ) , max( ( 1.0 - ( pow( saferPower41_g8502 , hueT38_g8499 ) * pow( saferPower42_g8502 , saturationT40_g8499 ) * pow( saferPower43_g8502 , brightnessT42_g8499 ) ) ) , 0.0 ) ) ) , _OutlineBias ));
				float InputA128_g8499 = ( _OutlineFade * temp_output_50_0_g8487 );
				float InputB128_g8499 = _OutlineFade;
				float localBranchFading1128_g8499 = BranchFading1( InputA128_g8499 , InputB128_g8499 );
				float4 lerpResult77_g8499 = lerp( temp_output_2_0_g8499 , lerpResult67_g8499 , localBranchFading1128_g8499);
				#ifdef _ENABLEOUTLINE_ON
				float4 staticSwitch74_g8499 = lerpResult77_g8499;
				#else
				float4 staticSwitch74_g8499 = temp_output_2_0_g8499;
				#endif
				float4 temp_output_412_0 = staticSwitch74_g8499;
				float4 temp_output_1_0_g8461 = temp_output_412_0;
				float4 break2_g8463 = temp_output_1_0_g8461;
				float temp_output_34_0_g8461 = shaderTime129;
				float3 hsvTorgb3_g8462 = HSVToRGB( float3(( tex2D( _NoiseTexture, ( ( glitchPosition117 + ( _GlitchNoiseSpeed * temp_output_34_0_g8461 ) ) * _GlitchNoiseScale ) ).r + ( temp_output_34_0_g8461 * _GlitchHueSpeed ) ),1.0,1.0) );
				float3 lerpResult23_g8461 = lerp( (temp_output_1_0_g8461).rgb , ( ( ( break2_g8463.x + break2_g8463.y + break2_g8463.z ) / 3.0 ) * _GlitchBrightness * hsvTorgb3_g8462 ) , glitchFade116);
				float4 appendResult27_g8461 = (float4(lerpResult23_g8461 , temp_output_1_0_g8461.a));
				#ifdef _ENABLEGLITCH_ON
				float4 staticSwitch123 = appendResult27_g8461;
				#else
				float4 staticSwitch123 = temp_output_412_0;
				#endif
				float4 temp_output_1_0_g8470 = staticSwitch123;
				float3 temp_output_4_0_g8470 = (temp_output_1_0_g8470).rgb;
				float4 break2_g8471 = float4( temp_output_4_0_g8470 , 0.0 );
				float3 temp_cast_11 = (max( ( ( break2_g8471.x + break2_g8471.y + break2_g8471.z ) / 3.0 ) , 0.1 )).xxx;
				float3 lerpResult8_g8470 = lerp( temp_cast_11 , temp_output_4_0_g8470 , _LightSaturation);
				float3 saferPower9_g8470 = max( lerpResult8_g8470 , 0.0001 );
				float3 temp_cast_12 = (_LightContrast).xxx;
				float4 appendResult14_g8470 = (float4(( ( _LightIntensity * pow( saferPower9_g8470 , temp_cast_12 ) ) + temp_output_4_0_g8470 ) , temp_output_1_0_g8470.a));
				#ifdef _ENABLELIGHT_ON
				float4 staticSwitch12_g8470 = appendResult14_g8470;
				#else
				float4 staticSwitch12_g8470 = temp_output_1_0_g8470;
				#endif
				float4 temp_output_1_0_g8468 = staticSwitch12_g8470;
				float temp_output_37_0_g8465 = shaderTime129;
				float2 temp_output_35_0_g8465 = shaderPosition109;
				float3 rotatedValue6_g8468 = RotateAroundAxis( float3( 1000,1000,0 ), float3( temp_output_35_0_g8465 ,  0.0 ), float3( 0,0,1 ), ( _StaticNoiseSpeed * temp_output_37_0_g8465 ) );
				float temp_output_7_0_g8468 = tex2D( _NoiseTexture, ( rotatedValue6_g8468.xy * _StaticNoiseScale ) ).r;
				float4 appendResult14_g8468 = (float4(temp_output_7_0_g8468 , temp_output_7_0_g8468 , temp_output_7_0_g8468 , temp_output_1_0_g8468.a));
				float4 lerpResult10_g8468 = lerp( temp_output_1_0_g8468 , appendResult14_g8468 , _StaticNoiseFade);
				#ifdef _ENABLESTATICNOISE_ON
				float4 staticSwitch15_g8468 = lerpResult10_g8468;
				#else
				float4 staticSwitch15_g8468 = temp_output_1_0_g8468;
				#endif
				float4 temp_output_1_0_g8483 = staticSwitch15_g8468;
				float2 temp_output_42_0_g8483 = temp_output_35_0_g8465;
				float3 hsvTorgb3_g8486 = HSVToRGB( float3(( ( ( _RainbowZoomDensity * distance( temp_output_42_0_g8483 , _RainbowCenter ) ) + ( tex2D( _NoiseTexture, ( temp_output_42_0_g8483 * _RainbowNoiseScale ) ).r * _RainbowNoiseFactor ) ) + ( _RainbowSpeed * temp_output_37_0_g8465 ) ),1.0,1.0) );
				float3 hsvTorgb36_g8483 = RGBToHSV( hsvTorgb3_g8486 );
				float3 hsvTorgb37_g8483 = HSVToRGB( float3(hsvTorgb36_g8483.x,_RainbowSaturation,( hsvTorgb36_g8483.z * _RainbowBrightness )) );
				float4 break2_g8485 = temp_output_1_0_g8483;
				float saferPower24_g8483 = max( ( ( break2_g8485.x + break2_g8485.y + break2_g8485.z ) / 3.0 ) , 0.0001 );
				float3 lerpResult46_g8483 = lerp( (temp_output_1_0_g8483).rgb , ( hsvTorgb37_g8483 * pow( saferPower24_g8483 , max( _RainbowContrast , 0.01 ) ) ) , _RainbowFade);
				float4 appendResult29_g8483 = (float4(lerpResult46_g8483 , temp_output_1_0_g8483.a));
				#ifdef _ENABLERAINBOW_ON
				float4 staticSwitch45_g8483 = appendResult29_g8483;
				#else
				float4 staticSwitch45_g8483 = temp_output_1_0_g8483;
				#endif
				float4 temp_output_1_0_g8467 = staticSwitch45_g8483;
				float3 hsvTorgb2_g8467 = RGBToHSV( temp_output_1_0_g8467.rgb );
				float3 hsvTorgb5_g8467 = HSVToRGB( float3(( floor( ( hsvTorgb2_g8467.x * _LimitColorsHueSteps ) ) / _LimitColorsHueSteps ),( floor( ( hsvTorgb2_g8467.y * _LimitColorsSaturationSteps ) ) / _LimitColorsSaturationSteps ),( floor( ( hsvTorgb2_g8467.z * _LimitColorsBrightnessSteps ) ) / _LimitColorsBrightnessSteps )) );
				float3 lerpResult8_g8467 = lerp( (temp_output_1_0_g8467).rgb , hsvTorgb5_g8467 , _LimitColorsFade);
				float4 appendResult4_g8467 = (float4(lerpResult8_g8467 , temp_output_1_0_g8467.a));
				#ifdef _ENABLELIMITCOLORS_ON
				float4 staticSwitch6_g8467 = appendResult4_g8467;
				#else
				float4 staticSwitch6_g8467 = temp_output_1_0_g8467;
				#endif
				float4 temp_output_1_0_g8478 = staticSwitch6_g8467;
				float4 break2_g8479 = temp_output_1_0_g8478;
				float temp_output_2_0_g8478 = ( ( break2_g8479.x + break2_g8479.y + break2_g8479.z ) / 3.0 );
				float temp_output_4_0_g8478 = step( _ColorStepsStep1 , temp_output_2_0_g8478 );
				float temp_output_10_0_g8478 = step( _ColorStepsStep3 , temp_output_2_0_g8478 );
				float temp_output_14_0_g8478 = max( ( step( _ColorStepsStep2 , temp_output_2_0_g8478 ) - temp_output_10_0_g8478 ) , 0.0 );
				float3 lerpResult31_g8478 = lerp( (temp_output_1_0_g8478).rgb , ( ( (_ColorStepsColor0).rgb * ( 1.0 - temp_output_4_0_g8478 ) ) + ( (_ColorStepsColor1).rgb * max( ( temp_output_4_0_g8478 - temp_output_14_0_g8478 ) , 0.0 ) ) + ( temp_output_14_0_g8478 * (_ColorStepsColor2).rgb ) + ( temp_output_10_0_g8478 * (_ColorStepsColor3).rgb ) ) , _ColorStepsFade);
				float4 appendResult34_g8478 = (float4(lerpResult31_g8478 , temp_output_1_0_g8478.a));
				#ifdef _ENABLECOLORSTEPS_ON
				float4 staticSwitch36_g8478 = appendResult34_g8478;
				#else
				float4 staticSwitch36_g8478 = temp_output_1_0_g8478;
				#endif
				float4 temp_output_1_0_g8480 = staticSwitch36_g8478;
				float3 temp_output_6_0_g8480 = (temp_output_1_0_g8480).rgb;
				float3 lerpResult3_g8480 = lerp( temp_output_6_0_g8480 , ( 1.0 - temp_output_6_0_g8480 ) , _NegativeFade);
				float4 appendResult7_g8480 = (float4(lerpResult3_g8480 , temp_output_1_0_g8480.a));
				#ifdef _ENABLENEGATIVE_ON
				float4 staticSwitch5_g8480 = appendResult7_g8480;
				#else
				float4 staticSwitch5_g8480 = temp_output_1_0_g8480;
				#endif
				float4 temp_output_1_0_g8481 = staticSwitch5_g8480;
				float4 break2_g8482 = temp_output_1_0_g8481;
				float3 lerpResult15_g8481 = lerp( (temp_output_1_0_g8481).rgb , ( pow( max( ( ( break2_g8482.x + break2_g8482.y + break2_g8482.z ) / 3.0 ) , 0.0001 ) , _SingleToneContrast ) * (_SingleToneColor).rgb ) , _SingleToneFade);
				float4 appendResult10_g8481 = (float4(lerpResult15_g8481 , temp_output_1_0_g8481.a));
				#ifdef _ENABLESINGLETONE_ON
				float4 staticSwitch2_g8481 = appendResult10_g8481;
				#else
				float4 staticSwitch2_g8481 = temp_output_1_0_g8481;
				#endif
				float4 temp_output_1_0_g8472 = staticSwitch2_g8481;
				float4 break2_g8473 = temp_output_1_0_g8472;
				float temp_output_3_0_g8472 = ( ( break2_g8473.x + break2_g8473.y + break2_g8473.z ) / 3.0 );
				float clampResult25_g8472 = clamp( ( ( ( ( temp_output_3_0_g8472 + _SplitToneShift ) - 0.5 ) * _SplitTonePolarize ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g8472 = lerp( (_SplitToneShadowsColor).rgb , (_SplitToneHighlightsColor).rgb , clampResult25_g8472);
				float saferPower26_g8472 = max( max( temp_output_3_0_g8472 , 0.0001 ) , 0.0001 );
				float3 lerpResult11_g8472 = lerp( (temp_output_1_0_g8472).rgb , ( lerpResult6_g8472 * pow( saferPower26_g8472 , _SplitToneContrast ) ) , _SplitToneFade);
				float4 appendResult18_g8472 = (float4(lerpResult11_g8472 , temp_output_1_0_g8472.a));
				#ifdef _ENABLESPLITTONE_ON
				float4 staticSwitch27_g8472 = appendResult18_g8472;
				#else
				float4 staticSwitch27_g8472 = temp_output_1_0_g8472;
				#endif
				float4 temp_output_1_0_g8474 = staticSwitch27_g8472;
				float3 hsvTorgb8_g8474 = RGBToHSV( temp_output_1_0_g8474.rgb );
				float saferPower5_g8474 = max( hsvTorgb8_g8474.z , 0.0001 );
				float3 hsvTorgb9_g8474 = HSVToRGB( float3(hsvTorgb8_g8474.x,hsvTorgb8_g8474.y,pow( saferPower5_g8474 , _Contrast )) );
				float4 appendResult4_g8474 = (float4(hsvTorgb9_g8474 , temp_output_1_0_g8474.a));
				#ifdef _ENABLECONTRAST_ON
				float4 staticSwitch7_g8474 = appendResult4_g8474;
				#else
				float4 staticSwitch7_g8474 = temp_output_1_0_g8474;
				#endif
				float4 temp_output_2_0_g8475 = staticSwitch7_g8474;
				float3 hsvTorgb1_g8475 = RGBToHSV( temp_output_2_0_g8475.rgb );
				float3 hsvTorgb3_g8475 = HSVToRGB( float3(_Hue,hsvTorgb1_g8475.y,hsvTorgb1_g8475.z) );
				float4 appendResult8_g8475 = (float4(hsvTorgb3_g8475 , temp_output_2_0_g8475.a));
				#ifdef _ENABLEHUE_ON
				float4 staticSwitch9_g8475 = appendResult8_g8475;
				#else
				float4 staticSwitch9_g8475 = temp_output_2_0_g8475;
				#endif
				float4 temp_output_6_0_g8476 = staticSwitch9_g8475;
				float4 break2_g8477 = temp_output_6_0_g8476;
				float3 temp_cast_34 = (( ( break2_g8477.x + break2_g8477.y + break2_g8477.z ) / 3.0 )).xxx;
				float3 lerpResult7_g8476 = lerp( temp_cast_34 , (temp_output_6_0_g8476).rgb , _Saturation);
				float4 appendResult3_g8476 = (float4(lerpResult7_g8476 , temp_output_6_0_g8476.a));
				#ifdef _ENABLESATURATION_ON
				float4 staticSwitch10_g8476 = appendResult3_g8476;
				#else
				float4 staticSwitch10_g8476 = temp_output_6_0_g8476;
				#endif
				float4 temp_output_2_0_g8466 = staticSwitch10_g8476;
				float4 appendResult6_g8466 = (float4(( (temp_output_2_0_g8466).rgb * _Brightness ) , temp_output_2_0_g8466.a));
				#ifdef _ENABLEBRIGHTNESS_ON
				float4 staticSwitch8_g8466 = appendResult6_g8466;
				#else
				float4 staticSwitch8_g8466 = temp_output_2_0_g8466;
				#endif
				float4 temp_output_280_0 = staticSwitch8_g8466;
				float4 lerpResult170 = lerp( temp_output_412_0 , temp_output_280_0 , fullFade153);
...
/*ASEBEGIN
Version=18900
573;34;1413;754;526.5176;-331.6112;1.257559;True;False
...
Node;AmplifyShaderEditor.FunctionNode;412;-111.3018,15.60661;Inherit;False;_Sample;109;;8487;9b7fc20dc45a5454c991b15678891b18;0;3;31;FLOAT2;0,0;False;1;FLOAT2;0,0;False;50;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;282;258.6629,284.8721;Inherit;False;OverlayGlitch;173;;8461;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;0;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;280;1011.876,95.09289;Inherit;False;_Color;43;;8465;87857c725b66a6f4a93d0f2a3f185435;0;4;1;COLOR;0,0,0,0;False;35;FLOAT2;0,0;False;36;SAMPLER2D;0;False;37;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;1994.455,296.1124;Float;False;True;-1;2;OverlayFilters.OverlayShaderGUI;0;6;Overlay Filters/Overlay G3;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;False;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;True;True;True;True;True;0;True;-9;False;False;False;False;False;False;False;True;True;0;True;-5;255;True;-8;255;True;-7;0;True;-4;0;True;-6;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;0;True;-11;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
WireConnection;412;31;110;0
WireConnection;412;1;381;0
WireConnection;412;50;190;0
WireConnection;282;34;131;0
WireConnection;282;31;121;0
WireConnection;282;33;122;0
WireConnection;282;29;120;0
WireConnection;282;1;412;0
WireConnection;123;1;412;0
...
ASEEND*/
//CHKSM=585031C0DAF35447EA2446DD9AA8BAAC49A668A0