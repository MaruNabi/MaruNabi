...
Shader "Overlay Filters/Overlay G1"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			ASE_DECLARE_SCREENSPACE_TEXTURE( _ScreenGrab1 )
			...
			float FlipY2_g8389( float ScreenOffsetY )
			{
				#if UNITY_UV_STARTS_AT_TOP
				return -ScreenOffsetY * _ProjectionParams.x;
				#else
			...
			float FlipY2_g8367( float ScreenOffsetY )
			{
				#if UNITY_UV_STARTS_AT_TOP
				return -ScreenOffsetY * _ProjectionParams.x;
				#else
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 temp_output_1_0_g8362 = localBranchFading2381;
				float2 temp_output_1_0_g8383 = temp_output_1_0_g8362;
				float4 screenColor16_g8383 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8383);
				float4 appendResult32_g8383 = (float4(max( (screenColor16_g8383).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8384 = temp_output_1_0_g8362;
				float2 break3_g8389 = ( _ZoomBlurPosition - shaderPosition109 );
				float ScreenOffsetY2_g8389 = break3_g8389.y;
				float localFlipY2_g8389 = FlipY2_g8389( ScreenOffsetY2_g8389 );
				float2 appendResult4_g8389 = (float2(break3_g8389.x , localFlipY2_g8389));
				float2 temp_output_66_0_g8384 = appendResult4_g8389;
				float2 normalizeResult16_g8384 = normalize( temp_output_66_0_g8384 );
				float clampResult15_g8384 = clamp( ( length( temp_output_66_0_g8384 ) - _ZoomBlurMinRadius ) , 0.0 , _ZoomBlurMaxRadius );
				float saferPower51_g8384 = max( clampResult15_g8384 , 0.0001 );
				float2 appendResult20_g8384 = (float2(_ScreenParams.y , _ScreenParams.x));
				float temp_output_50_0_g8362 = fullFade153;
				float2 temp_output_17_0_g8384 = ( normalizeResult16_g8384 * pow( saferPower51_g8384 , _ZoomBlurPower ) * _ZoomBlurOffset * ( appendResult20_g8384 / _ScreenParams.y ) * temp_output_50_0_g8362 );
				float2 temp_output_1_0_g8385 = ( temp_output_1_0_g8384 + ( temp_output_17_0_g8384 * float2( 0.0001,0.0001 ) ) );
				float4 screenColor16_g8385 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8385);
				float4 appendResult32_g8385 = (float4(max( (screenColor16_g8385).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8388 = ( temp_output_1_0_g8384 + ( temp_output_17_0_g8384 * float2( 0.0002,0.0002 ) ) );
				float4 screenColor16_g8388 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8388);
				float4 appendResult32_g8388 = (float4(max( (screenColor16_g8388).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8386 = ( temp_output_1_0_g8384 + ( temp_output_17_0_g8384 * float2( 0.0003,0.0003 ) ) );
				float4 screenColor16_g8386 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8386);
				float4 appendResult32_g8386 = (float4(max( (screenColor16_g8386).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8387 = ( temp_output_1_0_g8384 + ( temp_output_17_0_g8384 * float2( 0.0004,0.0004 ) ) );
				float4 screenColor16_g8387 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8387);
				float4 appendResult32_g8387 = (float4(max( (screenColor16_g8387).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_63_0_g8362 = ( ( appendResult32_g8385 + appendResult32_g8388 + appendResult32_g8386 + appendResult32_g8387 ) / 4.0 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch33_g8362 = temp_output_63_0_g8362;
				#else
				float4 staticSwitch33_g8362 = appendResult32_g8383;
				#endif
				float2 appendResult3_g8363 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 appendResult8_g8363 = (float2(_DirectionalBlurOffset , 0.0));
				float3 rotatedValue10_g8363 = RotateAroundAxis( float3( 0,0,0 ), float3( appendResult8_g8363 ,  0.0 ), float3( 0,0,1 ), ( _DirectionalBlurDirection * 0.01745329 ) );
				float2 break3_g8367 = (rotatedValue10_g8363).xy;
				float ScreenOffsetY2_g8367 = break3_g8367.y;
				float localFlipY2_g8367 = FlipY2_g8367( ScreenOffsetY2_g8367 );
				float2 appendResult4_g8367 = (float2(break3_g8367.x , localFlipY2_g8367));
				float2 temp_output_13_0_g8363 = ( ( appendResult3_g8363 / _ScreenParams.y ) * appendResult4_g8367 * temp_output_50_0_g8362 );
				float2 temp_output_1_0_g8363 = temp_output_1_0_g8362;
				float2 temp_output_1_0_g8366 = ( ( temp_output_13_0_g8363 * float2( 0.004,0.004 ) ) + temp_output_1_0_g8363 );
				float4 screenColor16_g8366 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8366);
				float4 appendResult32_g8366 = (float4(max( (screenColor16_g8366).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8364 = ( ( temp_output_13_0_g8363 * float2( 0.002,0.002 ) ) + temp_output_1_0_g8363 );
				float4 screenColor16_g8364 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8364);
				float4 appendResult32_g8364 = (float4(max( (screenColor16_g8364).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8365 = ( ( temp_output_13_0_g8363 * float2( -0.002,-0.002 ) ) + temp_output_1_0_g8363 );
				float4 screenColor16_g8365 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8365);
				float4 appendResult32_g8365 = (float4(max( (screenColor16_g8365).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 temp_output_1_0_g8368 = ( ( temp_output_13_0_g8363 * float2( -0.004,-0.004 ) ) + temp_output_1_0_g8363 );
				float4 screenColor16_g8368 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8368);
				float4 appendResult32_g8368 = (float4(max( (screenColor16_g8368).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_57_0_g8362 = ( ( appendResult32_g8366 + appendResult32_g8364 + appendResult32_g8365 + appendResult32_g8368 ) * 0.25 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch35_g8362 = ( ( temp_output_63_0_g8362 + temp_output_57_0_g8362 ) * 0.5 );
				#else
				float4 staticSwitch35_g8362 = temp_output_57_0_g8362;
				#endif
				#ifdef _ENABLEDIRECTIONALBLUR_ON
				float4 staticSwitch16_g8362 = staticSwitch35_g8362;
				#else
				float4 staticSwitch16_g8362 = staticSwitch33_g8362;
				#endif
				float2 temp_output_1_0_g8390 = temp_output_1_0_g8362;
				float2 appendResult26_g8390 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 temp_output_27_0_g8390 = ( appendResult26_g8390 / _ScreenParams.y );
				float temp_output_32_0_g8390 = ( _GaussianBlurOffset * 0.001 * temp_output_50_0_g8362 );
				float2 appendResult9_g8390 = (float2(temp_output_32_0_g8390 , temp_output_32_0_g8390));
				float2 temp_output_1_0_g8394 = ( temp_output_1_0_g8390 + ( temp_output_27_0_g8390 * appendResult9_g8390 ) );
				float4 screenColor16_g8394 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8394);
				float4 appendResult32_g8394 = (float4(max( (screenColor16_g8394).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult11_g8390 = (float2(-temp_output_32_0_g8390 , temp_output_32_0_g8390));
				float2 temp_output_1_0_g8393 = ( temp_output_1_0_g8390 + ( temp_output_27_0_g8390 * appendResult11_g8390 ) );
				float4 screenColor16_g8393 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8393);
				float4 appendResult32_g8393 = (float4(max( (screenColor16_g8393).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult15_g8390 = (float2(temp_output_32_0_g8390 , -temp_output_32_0_g8390));
				float2 temp_output_1_0_g8392 = ( temp_output_1_0_g8390 + ( temp_output_27_0_g8390 * appendResult15_g8390 ) );
				float4 screenColor16_g8392 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8392);
				float4 appendResult32_g8392 = (float4(max( (screenColor16_g8392).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult19_g8390 = (float2(-temp_output_32_0_g8390 , -temp_output_32_0_g8390));
				float2 temp_output_1_0_g8391 = ( temp_output_1_0_g8390 + ( temp_output_27_0_g8390 * appendResult19_g8390 ) );
				float4 screenColor16_g8391 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8391);
				float4 appendResult32_g8391 = (float4(max( (screenColor16_g8391).rgb , float3( 0,0,0 ) ) , 1.0));
				float4 temp_output_58_0_g8362 = ( ( appendResult32_g8394 + appendResult32_g8393 + appendResult32_g8392 + appendResult32_g8391 ) * 0.25 );
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch39_g8362 = ( ( temp_output_63_0_g8362 + temp_output_58_0_g8362 ) * 0.5 );
				#else
				float4 staticSwitch39_g8362 = temp_output_58_0_g8362;
				#endif
				#ifdef _ENABLEZOOMBLUR_ON
				float4 staticSwitch46_g8362 = ( ( temp_output_63_0_g8362 + temp_output_57_0_g8362 + temp_output_58_0_g8362 ) * 0.3333333 );
				#else
				float4 staticSwitch46_g8362 = ( ( temp_output_57_0_g8362 + temp_output_58_0_g8362 ) * 0.5 );
				#endif
				#ifdef _ENABLEDIRECTIONALBLUR_ON
				float4 staticSwitch17_g8362 = staticSwitch46_g8362;
				#else
				float4 staticSwitch17_g8362 = staticSwitch39_g8362;
				#endif
				#ifdef _ENABLEGAUSSIANBLUR_ON
				float4 staticSwitch2_g8362 = staticSwitch17_g8362;
				#else
				float4 staticSwitch2_g8362 = staticSwitch16_g8362;
				#endif
				float4 temp_output_44_0_g8369 = staticSwitch2_g8362;
				float2 temp_output_1_0_g8369 = temp_output_1_0_g8362;
				float2 appendResult26_g8369 = (float2(_ScreenParams.y , _ScreenParams.x));
				float2 temp_output_27_0_g8369 = ( appendResult26_g8369 / _ScreenParams.y );
				float temp_output_32_0_g8369 = ( _SharpenIntensity * 0.001 * temp_output_50_0_g8362 );
				float2 appendResult9_g8369 = (float2(temp_output_32_0_g8369 , temp_output_32_0_g8369));
				float2 temp_output_1_0_g8371 = ( temp_output_1_0_g8369 + ( temp_output_27_0_g8369 * appendResult9_g8369 ) );
				float4 screenColor16_g8371 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8371);
				float4 appendResult32_g8371 = (float4(max( (screenColor16_g8371).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult11_g8369 = (float2(-temp_output_32_0_g8369 , temp_output_32_0_g8369));
				float2 temp_output_1_0_g8370 = ( temp_output_1_0_g8369 + ( temp_output_27_0_g8369 * appendResult11_g8369 ) );
				float4 screenColor16_g8370 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8370);
				float4 appendResult32_g8370 = (float4(max( (screenColor16_g8370).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult15_g8369 = (float2(temp_output_32_0_g8369 , -temp_output_32_0_g8369));
				float2 temp_output_1_0_g8372 = ( temp_output_1_0_g8369 + ( temp_output_27_0_g8369 * appendResult15_g8369 ) );
				float4 screenColor16_g8372 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8372);
				float4 appendResult32_g8372 = (float4(max( (screenColor16_g8372).rgb , float3( 0,0,0 ) ) , 1.0));
				float2 appendResult19_g8369 = (float2(-temp_output_32_0_g8369 , -temp_output_32_0_g8369));
				float2 temp_output_1_0_g8373 = ( temp_output_1_0_g8369 + ( temp_output_27_0_g8369 * appendResult19_g8369 ) );
				float4 screenColor16_g8373 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8373);
				float4 appendResult32_g8373 = (float4(max( (screenColor16_g8373).rgb , float3( 0,0,0 ) ) , 1.0));
				#ifdef _ENABLESHARPEN_ON
				float4 staticSwitch43_g8369 = ( temp_output_44_0_g8369 + ( temp_output_44_0_g8369 - ( ( appendResult32_g8371 + appendResult32_g8370 + appendResult32_g8372 + appendResult32_g8373 ) * 0.25 ) ) );
				#else
				float4 staticSwitch43_g8369 = temp_output_44_0_g8369;
				#endif
				float4 temp_output_2_0_g8374 = staticSwitch43_g8369;
				#ifdef _OUTLINEFILLINSIDE_ON
				float4 staticSwitch73_g8374 = _OutlineFillColor;
				#else
				float4 staticSwitch73_g8374 = temp_output_2_0_g8374;
				#endif
				#ifdef _OUTLINEFILLLINES_ON
				float4 staticSwitch121_g8374 = _OutlineLineColor;
				#else
				float4 staticSwitch121_g8374 = temp_output_2_0_g8374;
				#endif
				float3 hsvTorgb4_g8374 = RGBToHSV( temp_output_2_0_g8374.rgb );
				float3 colorHSV35_g8374 = hsvTorgb4_g8374;
				float3 break10_g8381 = colorHSV35_g8374;
				float2 temp_output_5_0_g8374 = temp_output_1_0_g8362;
				float2 temp_output_1_0_g8382 = ( temp_output_5_0_g8374 + ( float2( 0.01,0 ) * _OutlineWidth ) );
				float4 screenColor16_g8382 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8382);
				float4 appendResult32_g8382 = (float4(max( (screenColor16_g8382).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8381 = RGBToHSV( appendResult32_g8382.xyz );
				float saferPower41_g8381 = max( distance( break10_g8381.x , hsvTorgb6_g8381.x ) , 0.0001 );
				float hueT38_g8374 = _OutlineHueTolerance;
				float saferPower42_g8381 = max( distance( break10_g8381.y , hsvTorgb6_g8381.y ) , 0.0001 );
				float saturationT40_g8374 = _OutlineSaturationTolerance;
				float saferPower43_g8381 = max( distance( break10_g8381.z , hsvTorgb6_g8381.z ) , 0.0001 );
				float brightnessT42_g8374 = _OutlineBrightnessTolerance;
				float3 break10_g8375 = colorHSV35_g8374;
				float2 temp_output_1_0_g8376 = ( temp_output_5_0_g8374 + ( float2( -0.01,0 ) * _OutlineWidth ) );
				float4 screenColor16_g8376 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8376);
				float4 appendResult32_g8376 = (float4(max( (screenColor16_g8376).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8375 = RGBToHSV( appendResult32_g8376.xyz );
				float saferPower41_g8375 = max( distance( break10_g8375.x , hsvTorgb6_g8375.x ) , 0.0001 );
				float saferPower42_g8375 = max( distance( break10_g8375.y , hsvTorgb6_g8375.y ) , 0.0001 );
				float saferPower43_g8375 = max( distance( break10_g8375.z , hsvTorgb6_g8375.z ) , 0.0001 );
				float3 break10_g8379 = colorHSV35_g8374;
				float2 temp_output_1_0_g8380 = ( temp_output_5_0_g8374 + ( _OutlineWidth * float2( 0,-0.01 ) ) );
				float4 screenColor16_g8380 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8380);
				float4 appendResult32_g8380 = (float4(max( (screenColor16_g8380).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8379 = RGBToHSV( appendResult32_g8380.xyz );
				float saferPower41_g8379 = max( distance( break10_g8379.x , hsvTorgb6_g8379.x ) , 0.0001 );
				float saferPower42_g8379 = max( distance( break10_g8379.y , hsvTorgb6_g8379.y ) , 0.0001 );
				float saferPower43_g8379 = max( distance( break10_g8379.z , hsvTorgb6_g8379.z ) , 0.0001 );
				float3 break10_g8377 = colorHSV35_g8374;
				float2 temp_output_1_0_g8378 = ( temp_output_5_0_g8374 + ( _OutlineWidth * float2( 0,0.01 ) ) );
				float4 screenColor16_g8378 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_ScreenGrab1,temp_output_1_0_g8378);
				float4 appendResult32_g8378 = (float4(max( (screenColor16_g8378).rgb , float3( 0,0,0 ) ) , 1.0));
				float3 hsvTorgb6_g8377 = RGBToHSV( appendResult32_g8378.xyz );
				float saferPower41_g8377 = max( distance( break10_g8377.x , hsvTorgb6_g8377.x ) , 0.0001 );
				float saferPower42_g8377 = max( distance( break10_g8377.y , hsvTorgb6_g8377.y ) , 0.0001 );
				float saferPower43_g8377 = max( distance( break10_g8377.z , hsvTorgb6_g8377.z ) , 0.0001 );
				float4 lerpResult67_g8374 = lerp( staticSwitch73_g8374 , staticSwitch121_g8374 , step( min( min( max( ( 1.0 - ( pow( saferPower41_g8381 , hueT38_g8374 ) * pow( saferPower42_g8381 , saturationT40_g8374 ) * pow( saferPower43_g8381 , brightnessT42_g8374 ) ) ) , 0.0 ) , max( ( 1.0 - ( pow( saferPower41_g8375 , hueT38_g8374 ) * pow( saferPower42_g8375 , saturationT40_g8374 ) * pow( saferPower43_g8375 , brightnessT42_g8374 ) ) ) , 0.0 ) ) , min( max( ( 1.0 - ( pow( saferPower41_g8379 , hueT38_g8374 ) * pow( saferPower42_g8379 , saturationT40_g8374 ) * pow( saferPower43_g8379 , brightnessT42_g8374 ) ) ) , 0.0 ) , max( ( 1.0 - ( pow( saferPower41_g8377 , hueT38_g8374 ) * pow( saferPower42_g8377 , saturationT40_g8374 ) * pow( saferPower43_g8377 , brightnessT42_g8374 ) ) ) , 0.0 ) ) ) , _OutlineBias ));
				float InputA128_g8374 = ( _OutlineFade * temp_output_50_0_g8362 );
				float InputB128_g8374 = _OutlineFade;
				float localBranchFading1128_g8374 = BranchFading1( InputA128_g8374 , InputB128_g8374 );
				float4 lerpResult77_g8374 = lerp( temp_output_2_0_g8374 , lerpResult67_g8374 , localBranchFading1128_g8374);
				#ifdef _ENABLEOUTLINE_ON
				float4 staticSwitch74_g8374 = lerpResult77_g8374;
				#else
				float4 staticSwitch74_g8374 = temp_output_2_0_g8374;
				#endif
				float4 temp_output_409_0 = staticSwitch74_g8374;
				float4 temp_output_1_0_g8336 = temp_output_409_0;
				float4 break2_g8338 = temp_output_1_0_g8336;
				float temp_output_34_0_g8336 = shaderTime129;
				float3 hsvTorgb3_g8337 = HSVToRGB( float3(( tex2D( _NoiseTexture, ( ( glitchPosition117 + ( _GlitchNoiseSpeed * temp_output_34_0_g8336 ) ) * _GlitchNoiseScale ) ).r + ( temp_output_34_0_g8336 * _GlitchHueSpeed ) ),1.0,1.0) );
				float3 lerpResult23_g8336 = lerp( (temp_output_1_0_g8336).rgb , ( ( ( break2_g8338.x + break2_g8338.y + break2_g8338.z ) / 3.0 ) * _GlitchBrightness * hsvTorgb3_g8337 ) , glitchFade116);
				float4 appendResult27_g8336 = (float4(lerpResult23_g8336 , temp_output_1_0_g8336.a));
				#ifdef _ENABLEGLITCH_ON
				float4 staticSwitch123 = appendResult27_g8336;
				#else
				float4 staticSwitch123 = temp_output_409_0;
				#endif
				float4 temp_output_1_0_g8345 = staticSwitch123;
				float3 temp_output_4_0_g8345 = (temp_output_1_0_g8345).rgb;
				float4 break2_g8346 = float4( temp_output_4_0_g8345 , 0.0 );
				float3 temp_cast_11 = (max( ( ( break2_g8346.x + break2_g8346.y + break2_g8346.z ) / 3.0 ) , 0.1 )).xxx;
				float3 lerpResult8_g8345 = lerp( temp_cast_11 , temp_output_4_0_g8345 , _LightSaturation);
				float3 saferPower9_g8345 = max( lerpResult8_g8345 , 0.0001 );
				float3 temp_cast_12 = (_LightContrast).xxx;
				float4 appendResult14_g8345 = (float4(( ( _LightIntensity * pow( saferPower9_g8345 , temp_cast_12 ) ) + temp_output_4_0_g8345 ) , temp_output_1_0_g8345.a));
				#ifdef _ENABLELIGHT_ON
				float4 staticSwitch12_g8345 = appendResult14_g8345;
				#else
				float4 staticSwitch12_g8345 = temp_output_1_0_g8345;
				#endif
				float4 temp_output_1_0_g8343 = staticSwitch12_g8345;
				float temp_output_37_0_g8340 = shaderTime129;
				float2 temp_output_35_0_g8340 = shaderPosition109;
				float3 rotatedValue6_g8343 = RotateAroundAxis( float3( 1000,1000,0 ), float3( temp_output_35_0_g8340 ,  0.0 ), float3( 0,0,1 ), ( _StaticNoiseSpeed * temp_output_37_0_g8340 ) );
				float temp_output_7_0_g8343 = tex2D( _NoiseTexture, ( rotatedValue6_g8343.xy * _StaticNoiseScale ) ).r;
				float4 appendResult14_g8343 = (float4(temp_output_7_0_g8343 , temp_output_7_0_g8343 , temp_output_7_0_g8343 , temp_output_1_0_g8343.a));
				float4 lerpResult10_g8343 = lerp( temp_output_1_0_g8343 , appendResult14_g8343 , _StaticNoiseFade);
				#ifdef _ENABLESTATICNOISE_ON
				float4 staticSwitch15_g8343 = lerpResult10_g8343;
				#else
				float4 staticSwitch15_g8343 = temp_output_1_0_g8343;
				#endif
				float4 temp_output_1_0_g8358 = staticSwitch15_g8343;
				float2 temp_output_42_0_g8358 = temp_output_35_0_g8340;
				float3 hsvTorgb3_g8361 = HSVToRGB( float3(( ( ( _RainbowZoomDensity * distance( temp_output_42_0_g8358 , _RainbowCenter ) ) + ( tex2D( _NoiseTexture, ( temp_output_42_0_g8358 * _RainbowNoiseScale ) ).r * _RainbowNoiseFactor ) ) + ( _RainbowSpeed * temp_output_37_0_g8340 ) ),1.0,1.0) );
				float3 hsvTorgb36_g8358 = RGBToHSV( hsvTorgb3_g8361 );
				float3 hsvTorgb37_g8358 = HSVToRGB( float3(hsvTorgb36_g8358.x,_RainbowSaturation,( hsvTorgb36_g8358.z * _RainbowBrightness )) );
				float4 break2_g8360 = temp_output_1_0_g8358;
				float saferPower24_g8358 = max( ( ( break2_g8360.x + break2_g8360.y + break2_g8360.z ) / 3.0 ) , 0.0001 );
				float3 lerpResult46_g8358 = lerp( (temp_output_1_0_g8358).rgb , ( hsvTorgb37_g8358 * pow( saferPower24_g8358 , max( _RainbowContrast , 0.01 ) ) ) , _RainbowFade);
				float4 appendResult29_g8358 = (float4(lerpResult46_g8358 , temp_output_1_0_g8358.a));
				#ifdef _ENABLERAINBOW_ON
				float4 staticSwitch45_g8358 = appendResult29_g8358;
				#else
				float4 staticSwitch45_g8358 = temp_output_1_0_g8358;
				#endif
				float4 temp_output_1_0_g8342 = staticSwitch45_g8358;
				float3 hsvTorgb2_g8342 = RGBToHSV( temp_output_1_0_g8342.rgb );
				float3 hsvTorgb5_g8342 = HSVToRGB( float3(( floor( ( hsvTorgb2_g8342.x * _LimitColorsHueSteps ) ) / _LimitColorsHueSteps ),( floor( ( hsvTorgb2_g8342.y * _LimitColorsSaturationSteps ) ) / _LimitColorsSaturationSteps ),( floor( ( hsvTorgb2_g8342.z * _LimitColorsBrightnessSteps ) ) / _LimitColorsBrightnessSteps )) );
				float3 lerpResult8_g8342 = lerp( (temp_output_1_0_g8342).rgb , hsvTorgb5_g8342 , _LimitColorsFade);
				float4 appendResult4_g8342 = (float4(lerpResult8_g8342 , temp_output_1_0_g8342.a));
				#ifdef _ENABLELIMITCOLORS_ON
				float4 staticSwitch6_g8342 = appendResult4_g8342;
				#else
				float4 staticSwitch6_g8342 = temp_output_1_0_g8342;
				#endif
				float4 temp_output_1_0_g8353 = staticSwitch6_g8342;
				float4 break2_g8354 = temp_output_1_0_g8353;
				float temp_output_2_0_g8353 = ( ( break2_g8354.x + break2_g8354.y + break2_g8354.z ) / 3.0 );
				float temp_output_4_0_g8353 = step( _ColorStepsStep1 , temp_output_2_0_g8353 );
				float temp_output_10_0_g8353 = step( _ColorStepsStep3 , temp_output_2_0_g8353 );
				float temp_output_14_0_g8353 = max( ( step( _ColorStepsStep2 , temp_output_2_0_g8353 ) - temp_output_10_0_g8353 ) , 0.0 );
				float3 lerpResult31_g8353 = lerp( (temp_output_1_0_g8353).rgb , ( ( (_ColorStepsColor0).rgb * ( 1.0 - temp_output_4_0_g8353 ) ) + ( (_ColorStepsColor1).rgb * max( ( temp_output_4_0_g8353 - temp_output_14_0_g8353 ) , 0.0 ) ) + ( temp_output_14_0_g8353 * (_ColorStepsColor2).rgb ) + ( temp_output_10_0_g8353 * (_ColorStepsColor3).rgb ) ) , _ColorStepsFade);
				float4 appendResult34_g8353 = (float4(lerpResult31_g8353 , temp_output_1_0_g8353.a));
				#ifdef _ENABLECOLORSTEPS_ON
				float4 staticSwitch36_g8353 = appendResult34_g8353;
				#else
				float4 staticSwitch36_g8353 = temp_output_1_0_g8353;
				#endif
				float4 temp_output_1_0_g8355 = staticSwitch36_g8353;
				float3 temp_output_6_0_g8355 = (temp_output_1_0_g8355).rgb;
				float3 lerpResult3_g8355 = lerp( temp_output_6_0_g8355 , ( 1.0 - temp_output_6_0_g8355 ) , _NegativeFade);
				float4 appendResult7_g8355 = (float4(lerpResult3_g8355 , temp_output_1_0_g8355.a));
				#ifdef _ENABLENEGATIVE_ON
				float4 staticSwitch5_g8355 = appendResult7_g8355;
				#else
				float4 staticSwitch5_g8355 = temp_output_1_0_g8355;
				#endif
				float4 temp_output_1_0_g8356 = staticSwitch5_g8355;
				float4 break2_g8357 = temp_output_1_0_g8356;
				float3 lerpResult15_g8356 = lerp( (temp_output_1_0_g8356).rgb , ( pow( max( ( ( break2_g8357.x + break2_g8357.y + break2_g8357.z ) / 3.0 ) , 0.0001 ) , _SingleToneContrast ) * (_SingleToneColor).rgb ) , _SingleToneFade);
				float4 appendResult10_g8356 = (float4(lerpResult15_g8356 , temp_output_1_0_g8356.a));
				#ifdef _ENABLESINGLETONE_ON
				float4 staticSwitch2_g8356 = appendResult10_g8356;
				#else
				float4 staticSwitch2_g8356 = temp_output_1_0_g8356;
				#endif
				float4 temp_output_1_0_g8347 = staticSwitch2_g8356;
				float4 break2_g8348 = temp_output_1_0_g8347;
				float temp_output_3_0_g8347 = ( ( break2_g8348.x + break2_g8348.y + break2_g8348.z ) / 3.0 );
				float clampResult25_g8347 = clamp( ( ( ( ( temp_output_3_0_g8347 + _SplitToneShift ) - 0.5 ) * _SplitTonePolarize ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g8347 = lerp( (_SplitToneShadowsColor).rgb , (_SplitToneHighlightsColor).rgb , clampResult25_g8347);
				float saferPower26_g8347 = max( max( temp_output_3_0_g8347 , 0.0001 ) , 0.0001 );
				float3 lerpResult11_g8347 = lerp( (temp_output_1_0_g8347).rgb , ( lerpResult6_g8347 * pow( saferPower26_g8347 , _SplitToneContrast ) ) , _SplitToneFade);
				float4 appendResult18_g8347 = (float4(lerpResult11_g8347 , temp_output_1_0_g8347.a));
				#ifdef _ENABLESPLITTONE_ON
				float4 staticSwitch27_g8347 = appendResult18_g8347;
				#else
				float4 staticSwitch27_g8347 = temp_output_1_0_g8347;
				#endif
				float4 temp_output_1_0_g8349 = staticSwitch27_g8347;
				float3 hsvTorgb8_g8349 = RGBToHSV( temp_output_1_0_g8349.rgb );
				float saferPower5_g8349 = max( hsvTorgb8_g8349.z , 0.0001 );
				float3 hsvTorgb9_g8349 = HSVToRGB( float3(hsvTorgb8_g8349.x,hsvTorgb8_g8349.y,pow( saferPower5_g8349 , _Contrast )) );
				float4 appendResult4_g8349 = (float4(hsvTorgb9_g8349 , temp_output_1_0_g8349.a));
				#ifdef _ENABLECONTRAST_ON
				float4 staticSwitch7_g8349 = appendResult4_g8349;
				#else
				float4 staticSwitch7_g8349 = temp_output_1_0_g8349;
				#endif
				float4 temp_output_2_0_g8350 = staticSwitch7_g8349;
				float3 hsvTorgb1_g8350 = RGBToHSV( temp_output_2_0_g8350.rgb );
				float3 hsvTorgb3_g8350 = HSVToRGB( float3(_Hue,hsvTorgb1_g8350.y,hsvTorgb1_g8350.z) );
				float4 appendResult8_g8350 = (float4(hsvTorgb3_g8350 , temp_output_2_0_g8350.a));
				#ifdef _ENABLEHUE_ON
				float4 staticSwitch9_g8350 = appendResult8_g8350;
				#else
				float4 staticSwitch9_g8350 = temp_output_2_0_g8350;
				#endif
				float4 temp_output_6_0_g8351 = staticSwitch9_g8350;
				float4 break2_g8352 = temp_output_6_0_g8351;
				float3 temp_cast_34 = (( ( break2_g8352.x + break2_g8352.y + break2_g8352.z ) / 3.0 )).xxx;
				float3 lerpResult7_g8351 = lerp( temp_cast_34 , (temp_output_6_0_g8351).rgb , _Saturation);
				float4 appendResult3_g8351 = (float4(lerpResult7_g8351 , temp_output_6_0_g8351.a));
				#ifdef _ENABLESATURATION_ON
				float4 staticSwitch10_g8351 = appendResult3_g8351;
				#else
				float4 staticSwitch10_g8351 = temp_output_6_0_g8351;
				#endif
				float4 temp_output_2_0_g8341 = staticSwitch10_g8351;
				float4 appendResult6_g8341 = (float4(( (temp_output_2_0_g8341).rgb * _Brightness ) , temp_output_2_0_g8341.a));
				#ifdef _ENABLEBRIGHTNESS_ON
				float4 staticSwitch8_g8341 = appendResult6_g8341;
				#else
				float4 staticSwitch8_g8341 = temp_output_2_0_g8341;
				#endif
				float4 temp_output_280_0 = staticSwitch8_g8341;
...
/*ASEBEGIN
Version=18900
573;34;1413;754;1831.033;499.1498;3.17762;True;False
...
Node;AmplifyShaderEditor.FunctionNode;409;-111.3018,15.60661;Inherit;False;_Sample;109;;8362;9b7fc20dc45a5454c991b15678891b18;0;3;31;FLOAT2;0,0;False;1;FLOAT2;0,0;False;50;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;282;258.6629,284.8721;Inherit;False;OverlayGlitch;173;;8336;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;0;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;280;1011.876,95.09289;Inherit;False;_Color;43;;8340;87857c725b66a6f4a93d0f2a3f185435;0;4;1;COLOR;0,0,0,0;False;35;FLOAT2;0,0;False;36;SAMPLER2D;0;False;37;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;1994.455,296.1124;Float;False;True;-1;2;OverlayFilters.OverlayShaderGUI;0;6;Overlay Filters/Overlay G1;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;False;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;True;True;True;True;True;0;True;-9;False;False;False;False;False;False;False;True;True;0;True;-5;255;True;-8;255;True;-7;0;True;-4;0;True;-6;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;0;True;-11;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;0;;0;0;Standard;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=90D147B3A0CCDEAC6179A0FB74D50EA8F9053A60